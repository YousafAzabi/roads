...
exports.compare = (roadOS, dataOSM, roadCounters, mismatch, arrayOS, arrayOSM) => {
  ...
  if (index === 0) roadCounters.noMatch ++;
  else if (index === 1) roadCounters.oneMatch ++;
  else roadCounters.multiMatch ++;
  return true;
}
